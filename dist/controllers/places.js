...
exports.lookupPlace = void 0;
const axios_1 = __importDefault(require("axios"));
const lookupPlace = async (req, res) => {
    const { placeName } = req.body;
    const apiKey = process.env.GOOGLE_API_KEY;
    try {
        // 1. Find place_id
        const searchRes = await axios_1.default.get("https://maps.googleapis.com/maps/api/place/findplacefromtext/json", {
            params: {
                input: placeName,
                inputtype: "textquery",
                fields: "place_id",
