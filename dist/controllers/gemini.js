...
exports.updateItinerary = exports.createTrip = void 0;
        ...
        try {
            ...
            const result = await model.generateContent({
                ...
                generationConfig: {
                    ...
                    responseSchema: AIprompt_1.schema
                },
            });
...
const updateItinerary = async (req, res) => {
    try {
        ...
        const currentUser = await (0, users_1.getUserById)(userId);
        ...
        const prompt = (0, AIprompt_1.UPDATE_PROMPT)(trip, changeRequest);
        ...
        const newTrip = await (0, trip_1.updateTripItinerary)(userId, tripId, updatedItinerary);
