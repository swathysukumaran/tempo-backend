...
exports.schema = exports.UPDATE_PROMPT = exports.AI_PROMPT = void 0;
const AI_PROMPT = (destination, timeframe, travelers, preferences, budget) => {
    return `
...
const UPDATE_PROMPT = (trip, changeRequest) => {
    return `
...
exports.UPDATE_PROMPT = UPDATE_PROMPT;
exports.schema = {
    "type": "object",
    "properties": {
        "generatedItinerary": {
